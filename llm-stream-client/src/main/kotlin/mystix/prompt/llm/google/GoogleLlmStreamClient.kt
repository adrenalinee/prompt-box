    ...
    private fun mapFunctionCallingMode(choice: ResponseCreateParams.ToolChoice?): GoogleFunctionCallingMode? {
        ...
        return choice.accept(
            object : ResponseCreateParams.ToolChoice.Visitor<GoogleFunctionCallingMode?> {
                override fun visitOptions(options: com.openai.models.responses.ToolChoiceOptions): GoogleFunctionCallingMode? {
                    return when (options.value()) {
                        com.openai.models.responses.ToolChoiceOptions.Value.NONE -> GoogleFunctionCallingMode.NONE
                        com.openai.models.responses.ToolChoiceOptions.Value.AUTO -> GoogleFunctionCallingMode.AUTO
                        com.openai.models.responses.ToolChoiceOptions.Value.REQUIRED -> GoogleFunctionCallingMode.ANY
                        com.openai.models.responses.ToolChoiceOptions.Value._UNKNOWN -> GoogleFunctionCallingMode.AUTO
                    }
                }

                override fun visitAllowed(allowed: com.openai.models.responses.ToolChoiceAllowed): GoogleFunctionCallingMode? {
                    return GoogleFunctionCallingMode.ANY
                }

                override fun visitTypes(types: com.openai.models.responses.ToolChoiceTypes): GoogleFunctionCallingMode? {
                    return GoogleFunctionCallingMode.ANY
                }

                override fun visitFunction(function: com.openai.models.responses.ToolChoiceFunction): GoogleFunctionCallingMode? {
                    return GoogleFunctionCallingMode.ANY
                }

                override fun visitMcp(mcp: com.openai.models.responses.ToolChoiceMcp): GoogleFunctionCallingMode? {
                    return GoogleFunctionCallingMode.ANY
                }

                override fun visitCustom(custom: com.openai.models.responses.ToolChoiceCustom): GoogleFunctionCallingMode? {
                    return GoogleFunctionCallingMode.ANY
                }

                override fun visitApplyPatch(applyPatch: com.openai.models.responses.ToolChoiceApplyPatch): GoogleFunctionCallingMode? {
                    return GoogleFunctionCallingMode.ANY
                }

                override fun visitShell(shell: com.openai.models.responses.ToolChoiceShell): GoogleFunctionCallingMode? {
                    return GoogleFunctionCallingMode.ANY
                }
            }
        )
