    ...
    private fun mapToolChoice(choice: ResponseCreateParams.ToolChoice?): XaiToolChoice? {
        ...
        return choice.accept(
            object : ResponseCreateParams.ToolChoice.Visitor<XaiToolChoice?> {
                ...
                override fun visitMcp(mcp: com.openai.models.responses.ToolChoiceMcp): XaiToolChoice {
                    return XaiToolChoice.Required
                }

                override fun visitCustom(custom: com.openai.models.responses.ToolChoiceCustom): XaiToolChoice {
                    return XaiToolChoice.Required
                }

                override fun visitApplyPatch(applyPatch: com.openai.models.responses.ToolChoiceApplyPatch): XaiToolChoice {
                    return XaiToolChoice.Required
                }

                override fun visitShell(shell: com.openai.models.responses.ToolChoiceShell): XaiToolChoice {
                    return XaiToolChoice.Required
                }
            }
        )
